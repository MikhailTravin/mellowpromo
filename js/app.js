...
const swiperServiseone = new Swiper('.level__body', {
	slidesPerView: 3,
	autoHeight: false,
	speed: 800,
	navigation: {
		nextEl: '.level__arrow-next',
		prevEl: '.level__arrow-prev',
	},
	breakpoints: {
		320: {
			slidesPerView: 1,
...
const swiperServisetwo = new Swiper('.audit__row', {
	slidesPerView: 3,
	autoHeight: false,
	speed: 800,
	navigation: {
		nextEl: '.audit__arrow-next',
		prevEl: '.audit__arrow-prev',
	},
	breakpoints: {
		320: {
			slidesPerView: 1,
...
const swiperAbout = new Swiper('.team__slider', {
	slidesPerView: 1,
	spaceBetween: 10,
	autoHeight: false,
	speed: 800,
...
if (iconMenu != null) {
	let delay = 500;
	let menuBody = document.querySelector(".tabs-main-home__body");
